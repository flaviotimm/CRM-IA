...
export default function Configuracao() {
  ...
  const [instanceName, setInstanceName] = useState("Comercial Timm Advogado");
  ...
  async function finish() {
    ...
    await refresh();
    setSaving(false);
    toast.success("Configuração concluída! Bem-vindo(a) ao Timm Advogado.");
    navigate("/");
  }
            ...
            <>
              <div className="space-y-1.5">
                ...
                <Textarea rows={4} value={company} onChange={(e) => setCompany(e.target.value)}
                  placeholder="O que o Timm Advogado oferece, para quem, diferenciais…" />
