...
export default function Configuracao() {
  ...
  const [instanceName, setInstanceName] = useState("Comercial Q7");
  ...
  async function finish() {
    ...
    await refresh();
    setSaving(false);
    toast.success("Configuração concluída! Bem-vindo(a) à Q7 Educação.");
    navigate("/");
  }
            ...
            <>
              <div className="space-y-1.5">
                ...
                <Textarea rows={4} value={company} onChange={(e) => setCompany(e.target.value)}
                  placeholder="O que a Q7 Educação oferece, para quem, diferenciais…" />
